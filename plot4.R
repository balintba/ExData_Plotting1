...
## Third plot
  plot(x = filtered_data$Date,y=filtered_data$Voltage,type = "l",ylab="Voltage",xlab="datetime")

## Fourth plot
  plot(x = filtered_data$Date,y=filtered_data$Global_reactive_power,type = "l",ylab="Global_reactive_power",xlab="datetime")
